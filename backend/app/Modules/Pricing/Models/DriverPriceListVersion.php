...
final class DriverPriceListVersion extends Model
{
    ...
    protected $table = 'driver_price_list_versions';
    ...
    /** @return BelongsTo<DriverPriceList, $this> */
    public function driverPriceList(): BelongsTo
    {
        return $this->belongsTo(
            DriverPriceList::class,
        );
    }
    ...
    /** @return HasMany<DriverPriceListItem, $this> */
    public function items(): HasMany
    {
        return $this->hasMany(
            DriverPriceListItem::class,
        )->orderBy('position');
    }
    ...
    public function isApplicableOn(
        ...
        if (
            ...
            || (
                ($this->isReplaced() || $this->isExpired())
