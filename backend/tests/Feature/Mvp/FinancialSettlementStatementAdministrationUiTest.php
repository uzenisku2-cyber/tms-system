...
final class FinancialSettlementStatementAdministrationUiTest extends TestCase
{
    public function test_settlement_statement_administration_exposes_exact_lifecycle_and_output_controls(): void
    {
        ...
        foreach ([
            ...
            'id="openBankEvidence"', 'id="bankEvidenceModal"', 'id="bankEvidenceRows"',
            '/api/v1/bank-transaction-evidence?', 'allocated_amount_minor', 'remaining_capacity_amount_minor',
            'capacity_state', 'settlement_candidates', 'supplier_fuel_payments', 'vehicle_cost_matches',
            'amount_breakdowns',
