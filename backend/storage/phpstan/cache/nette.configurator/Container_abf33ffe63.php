...
class Container_abf33ffe63 extends _PHPStan_7891782a6\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0460(): PHPStan\Reflection\ClassReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\ClassReflectionFactory {
			...
			public function __construct(Container_abf33ffe63 $container)
			{
	...
	public function createServiceContainer(): Container_abf33ffe63
	{
		return $this;
	}
