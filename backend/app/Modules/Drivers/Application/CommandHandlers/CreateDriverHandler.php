...
{
    public function handle(CreateDriverCommand $command): Driver
    {
        $driver = Driver::create([
            ...
            'license_number' => $command->data['license_number'],

            'license_category' => $command->data['license_category'] ?? null,
