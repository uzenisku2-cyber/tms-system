...
class Container_865f21bc35 extends _PHPStan_7891782a6\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0460(): PHPStan\Reflection\ClassReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\ClassReflectionFactory {
			...
			public function __construct(Container_865f21bc35 $container)
			{
	...
	public function createServiceContainer(): Container_865f21bc35
	{
		return $this;
	}
