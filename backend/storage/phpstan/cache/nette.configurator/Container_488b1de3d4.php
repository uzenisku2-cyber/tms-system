...
class Container_488b1de3d4 extends _PHPStan_7891782a6\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService0460(): PHPStan\Reflection\ClassReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\ClassReflectionFactory {
			...
			public function __construct(Container_488b1de3d4 $container)
			{
	...
	public function createServiceContainer(): Container_488b1de3d4
	{
		return $this;
	}
