...
class TripRealtimeBroadcast implements ShouldBroadcastNow
{
    ...
    public function broadcastWith(): array
    {
        ...
        return [
            ...
            'vehicle_type' => $this->payload['vehicle_type']
                ?? null,
            ...
            'registration_number' => $this->payload['registration_number']
                ?? null,
            ...
            'driver_name' => $this->payload['driver_name']
                ?? null,
